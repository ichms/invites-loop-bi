...
--   born_in                      birthplace; quasi-identifier in this cohort
--   intg_anlys,
--   discovery_collection_status  operational JSONB, not modelled
--
-- Weight and height are selected as an enrolment-time current-profile snapshot,
-- not a longitudinal measurement series — those stay in fct_measurement. Zeros are
-- treated as missing; coverage is tested dynamically.
