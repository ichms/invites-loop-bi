---
name: invites-loop-olap-connection
...
- Examples include:
  ...
  - Analyzing data distributions, counts, and relations within the `invites_dw` service.
- **DO NOT** use this skill for general factual knowledge or coding questions unrelated to the project's specific database.

## Instructions
- **Connection Command:** Execute `psql service=invites_dw` to interact with the database.
